...
export default class Pokemon extends Phaser.Scene {
    ...
    private pokemonSprites: Phaser.GameObjects.Image[] = [];
    ...
    create() {
        ...
        this.actionKey = this.scene.scene.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.A);
    ...
    navigatePokemon(direction: string) {
